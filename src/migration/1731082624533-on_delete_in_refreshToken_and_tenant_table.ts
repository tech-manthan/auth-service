...
export class OnDeleteInRefreshTokenAndTenantTable1731082624533
  implements MigrationInterface
{
  name = "OnDeleteInRefreshTokenAndTenantTable1731082624533";
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "users" ADD CONSTRAINT "FK_c58f7e88c286e5e3478960a998b" FOREIGN KEY ("tenantId") REFERENCES "tenants"("id") ON DELETE SET NULL ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
